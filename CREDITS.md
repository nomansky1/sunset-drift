...
- **Car models**:
  ...
  - Fleet cars (COUPE, EXOTIC, HATCH, SUV, PICKUP) by **Quaternius**, CC0 — generic/original designs, NOT
    modeled after any real manufacturer (no branded/trademarked vehicles are used; the game is sold commercially).
